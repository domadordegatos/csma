    ...
    <div class="col-sm-4">
        <div class="input-group input-group-sm">
            <div class="input-group-prepend">
                <span class="input-group-text bg-dark text-white">Desde</span>
            </div>
            <input type="date" id="f_inicio_rep" class="form-control">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="input-group input-group-sm">
            ...
            <input type="date" id="f_final_rep" class="form-control">
        </div>
    </div>
</div>
...
function imprimirReporteDetallado(id_usuario) {
    // Obtenemos las fechas de los inputs
    var fecha1 = $('#f_inicio_rep').val();
    var fecha2 = $('#f_final_rep').val();

    // Validación de seguridad
    if (fecha1 == "" || fecha2 == "") {
        alertify.error("Debe seleccionar un rango de fechas (Desde/Hasta) para generar el reporte");
        return false;
    }

    // Abrimos el generador de PDF en una nueva pestaña
    // Pasamos el ID del usuario y el rango de fechas por la URL (GET)
    var url = "../../controller/ventas/pdf_estudiante_rango.php?id=" + id_usuario + "&f1=" + fecha1 + "&f2=" + fecha2;

...
<body onload="r_codigo();">
    ...
    <div class="container-x d-flex mt-3">
        <div class="contenedor1 w-50 ml-3">
            ...
            <h1 class="display-4 text-white">Cartera de Almuerzos
...
<script>
    ...
    $(document).ready(function() {
        $("select[name=nombredata]").change(function() {
            ...
            $.ajax({
                    type:"POST",
                    url:"../../controller/almuerzos/consulta_movimientos.php", //validacion de datos de registro
                    data:cadena,
                    success:function(r){
                        if(r==1){
        ...
        function consulta(id){
            ...
            cadena="form1=" + id +
                   "&form2=" + sin_fecha;
                    $.ajax({
                    type:"POST",
                    url:"../../controller/almuerzos/consulta_detallada.php", //validacion de datos de registro
                    data:cadena,
                    success:function(r){
                        if(r==1){
                            alertify.success("Registros encontrados");

...
<body onload="cancelar_compra()" style="overflow-x: hidden;">
...
<input type="text" id="yeimicode" name="yeimicode" value="<?php echo $user;?>" hidden>
        ...
        <div class="container-x d-flex mt-4">
            <div class="contenedor1" style="width: 40%; margin-left: 3rem; margin-right: 3rem;">
                <div class="row my-3">
                    <div class="col-sm-4 border border-white d-flex justify-content-center align-items-center" style="border-top-left-radius: 20px; border-bottom-left-radius: 20px;">
                    ...
                    <div class="col-sm-3 text-white border border-white" style="border-bottom-right-radius: 20px; border-top-right-radius: 20px;">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3>Cartera</h3>
                            </div>
                        ...
                        <div class="row text">
                            <div class="col-sm-12">
                                ...
                                <input type="text" disabled class="form-control" id="pequeno">
                            </div>
                        </div>
                        <div class="row text">
                            <div class="col-sm-12">
                                <label for="">Grande</label>
                                <input type="text" disabled class="form-control" id="grande">
                            </div>
                        </div>
                        <div class="row text">
                            <div class="col-sm-12">
                                <label for="">Docente</label>
                                <input type="text" disabled class="form-control" id="docente">
                            </div>
                        </div>
                        <div class="row text">
                            <div class="col-sm-12">
                                <label for="">COMBO</label>
                                <input type="text" disabled class="form-control" id="saludable">
                            </div>
                        </div>
                ...
                <div class="row w-100 mb-2">
                    <div class="col-sm-12 d-flex justify-content-center pt-0 mt-0">
                        ...
                        <button id="activar_compras" class="btn btn-primary" onclick="activar_compras()" style="display: none;">X</button>
                    </div>
                </div>
                <div class="row m-auto">
                    <div class="col-sm-3">
                        <input class="form-control form-control-sm col-sm-12" autofocus type="text" id="nombre" name="nombre" placeholder="name..">
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row mt-5 w-100">
                    <div class="col-sm-12">
                        <div class="row" id="conjunto_de_botones">
                            <div class="col-sm-4" style="padding: 0 3px 0 3px;"><button class="py-4 btn btn-block btn-lg btn-info" onclick="cancelar_compra()">Cancelar compra</button></div>
                            <div class="col-sm-4" style="padding: 0 3px 0 3px;"><button class="py-4 btn btn-block btn-lg btn-success" onclick="crearventa()">Realizar compra</button></div>
                            <div class="col-sm-4" style="padding: 0 3px 0 3px;"><button class="py-4 btn btn-block btn-lg btn-warning" onclick="prestar_dinero()" id="prestar" style="display: none;">Prestar dinero</button></div>
                        </div>
            ...
            <div class="contenedor2" style="width: 60%;">
                <div class="row w-100">
                ...
                <div class="row w-100">
                    <div class="col-sm-12 text-center">
                        <button class="btn btn-warning" onclick="carrito_compras(21)">
                            <img src="../media/recursos/productos/21.png" alt="" width="80px" height="80px">
                        </button>
                        <button class="btn btn-secondary" onclick="carrito_compras(22)">
                            <img src="../media/recursos/productos/22.png" alt="" width="80px" height="80px">
                        </button>
                        <button class="btn btn-primary" onclick="carrito_compras(23)">
                            <img src="../media/recursos/productos/23.png" alt="" width="80px" height="80px">
                        </button>
                        <button class="btn btn-light" onclick="carrito_compras(24)">
...
<script>
    ...
    function prestar_dinero() {
        ...
        $.ajax({
            type: "POST",
            data: cadena,
            url: "../../controller/almuerzos/crear_venta_prestada.php",
            success: function(r) {
                if (r == 1) {
                    ...
                    alertify.error("Sin saldo... Prestale");
                    $('#carrito_temp').load("carrito_temp.php");
                } else if (r == -1) {
                    $('#carrito_temp').load("carrito_temp.php");
    ...
    function crearventa() {
        ...
        $.ajax({
            type: "POST",
            data: cadena,
            url: "../../controller/almuerzos/crear_venta.php",
            success: function(r) {
                if (r == 1) {
                    solicitar_informacion();
                    $('#carrito_temp').load("carrito_temp.php");
    ...
    function carrito_compras(idarticulo) {
        $.ajax({
            ...
            url: "../../controller/almuerzos/carrito_temporal.php",
            success: function(r) {
                if (r == 2) {

...
session_start();
 ?>
      <?php
      if (isset($_SESSION['tabla_activos_csma'])):
        foreach (@$_SESSION['tabla_activos_csma'] as $key) {
        $dat=explode("||", $key);
       ?>
       <tr class="table-sm">
...
<td>
  <button type="button" class="btn btn-sm btn-warning btn_editar_fila"
          data-id="<?php echo htmlspecialchars($dat[0]); ?>">

        ...
        <div class="pl-5 contenedor2 mt-2 text-white w-50">
            ...
            <div class="row">
                <div class="col-12 text-white">
                    <h6 class="text-center text-dark">Medio de pago</h6>
                    <div class="row">
                        <div class="col d-flex justify-content-center text-dark">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" checked name="medioPago" id="medioPago" value="1">
                                <label class="form-check-label" for="inlineRadio1">Efectivo</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="medioPago" id="inlineRadio2" value="2">
                                <label class="form-check-label" for="inlineRadio2">Transferencia</label>
                              </div>
                        </div>
                        <div class="col-6">
                            <input type="number" class="form-control form-control-sm" placeholder="$10.000 valor cargado" id="valor_almuerzos">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                <label for="saludable" class="col-sm-3 col-form-label"><b>COMBO</b> </label>
                <div class="col-sm-3">
...
<script>
    ...
    $("input[name=codigo]").change(function(){
      cadena="form1=" + $('#codigo').val();
          ...
          function actualizar(){//terminado
            if($('#pequeno').val() == '' || $('#grande').val() == '' || $('#docente').val() == '' || $('#saludable').val() == ''|| $('#valor_almuerzos').val() == '' || $('#codigo').val() == ''){
                alertify.error("debes llenar todos los campos");
            }else{
                var medioPagoSeleccionado = $("input[name='medioPago']:checked").val();
            ...
            cadena="form1=" + $('#pequeno').val()+
                   ...
                   "&form4=" + $('#saludable').val()+
                   "&form5=" + $('#u_id').val()+
                   "&form6=" + $('#valor_almuerzos').val()+
                   "&form7=" + medioPagoSeleccionado;
